<div class="card abbe-card-hover" style="width: 18rem;">
  ...
  <div class="d-flex justify-content-around mb-3"><?php the_tags('<span class="tag"><i class="fa fa-tag me-1"></i>', '</span><span class="tag"><i class="fa fa-tag me-1"></i>', '</span>'); ?></div>
</div>  